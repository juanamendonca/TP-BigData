...
6. **Limitaciones de Serving en Cassandra (Consulta Top-N):** Cassandra no soporta agrupamiento y ordenamiento dinámico por métricas en tiempo de ejecución. Se definió realizar la consulta por rango de fechas en CQL y efectuar la agregación final (Top-N) del lado del cliente/aplicación.
